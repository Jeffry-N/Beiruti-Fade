...
const styles = StyleSheet.create({
  ...
  email: { fontSize: 12 },
  card: { borderRadius: 12, borderWidth: 1, padding: 16, marginBottom: 16, width: '100%', maxWidth: 480 },
  sectionTitle: { fontSize: 16, fontWeight: '700', marginBottom: 8 },
  bio: { fontSize: 14, lineHeight: 20 },
  flexSpacer: { flex: 1 },
  backButton: { backgroundColor: '#ED1C24', paddingVertical: 14, borderRadius: 8, alignItems: 'center', alignSelf: 'center', width: '100%', maxWidth: 480, marginTop: 16 },
